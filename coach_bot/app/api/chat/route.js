  ...
  try {
    ...
    if (!sessionMemory[session_id]) {
      let initialSystemPrompt = `
        ...
        2.  Concluding Monologue: Once the user has typed their numerical rating, your response MUST begin by acknowledging their rating (e.g., "Thank you for your rating of [user's typed number]!") AND THEN, as part of that SAME continuous and uninterrupted response, you MUST deliver ALL the following points (b, c, d, and e). Do NOT pause or ask any new questions after acknowledging the rating; the acknowledgment is the START of your single concluding monologue.
            a.  Acknowledge Rating: (This is the start of your monologue as described above)
            b.  Empowering Observation: IMMEDIATELY follow with a short, empowering observation based on the user's reflections and stated goals *from the current session*.
            c.  Session Summary: Then, provide a clear, concise summary of the main topics discussed and insights generated *by the user during the current session*.
            d.  Motivations/Goals: Then, briefly reiterate the user's key motivations and goals identified *during the current session*.
            e.  Reflective Feedback & End Marker: Finally, offer short reflective feedback encouraging self-awareness and growth, specifically tied to what was discussed *in the current session*. After this feedback, you MUST append the exact string "[SESSION_ENDED_MARKER]" and nothing else.
